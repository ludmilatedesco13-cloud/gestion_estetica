...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $precio_costo = isset($_POST['precio_costo']) ? floatval(preg_replace('/[^\d.]/', '', $_POST['precio_costo'])) : 0;
        $precio_venta = isset($_POST['precio_venta']) ? floatval(preg_replace('/[^\d.]/', '', $_POST['precio_venta'])) : 0;
        ...
        if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($ext, $permitidos)) {
                ...
                // Mover la imagen desde el directorio temporal de WAMP/servidor a la carpeta del proyecto
        ...
        // Redirección exitosa de vuelta al index
