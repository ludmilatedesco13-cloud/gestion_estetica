...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="header-nav">
            ...
            <a href="#sec-venta">Nueva Venta</a>
                    ...
                    <tbody>
                        ...
                        try {
                            ...
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $foto_url = !empty($row['foto']) ? $row['foto'] : "img/producto_defecto.jpg";
                                ...
                                echo "<td>
                                        ...
                                        <a href='editar_producto.php?id={$row['id']}' class='btn-icon' title='Editar' style='color: #7a9e9f;'>✏️</a>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (btnAgregar) {
                btnAgregar.addEventListener("click", function() {
                    ...
                    // Buscamos la opción elegida en la datalist
                    ...
                    // Validamos stock sumando lo que ya esté en el carrito
            ...
            // 2. Control de Alertas Emergentes con SweetAlert2
            ...
            // Limpiamos la URL para evitar re-alertas en F5
