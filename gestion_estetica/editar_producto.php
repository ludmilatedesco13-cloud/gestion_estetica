...
// 1. Validar que la sesión exista y que el rol sea "admin"
...
// 2. Obtener los datos actuales del producto seleccionado usando la columna 'id'
$producto = null;
...
// 3. Procesar la actualización cuando se envíe el formulario modificado
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Redirección POST-Redirect-GET limpia
